  ...
  return (
      <form className="w-full flex flex-col my-auto text-gray-700 p-8 items-center overflow-y-scroll animate-in"
        ...
        <div className="w-full grid grid-cols-1 gap-2 mt-8">
          <FormInput type="email" label="Correo" size="small" placeholder="Ingresa el correo..."
                     hookForm={{ ...register('email') }}/>
          <FormInput type="password" label="Contraseña" size="small" placeholder="Ingresa el correo..."
                     hookForm={{ ...register('password') }}/>
          <FormInput type="password" label="Confirmar contraseña" size="small" placeholder="Ingresa el correo..."
        ...
        <div className="w-full flex flex-col text-xs py-4 gap-2">
          <div className="flex items-center gap-2">
            ...
            <label htmlFor="politicy">
              Acepto las <span className="underline hover:cursor-pointer hover:text-blue-700">Politicas de
              privacidad</span>
            </label>
          </div>
          <div className="flex items-center gap-2">
            ...
            <label htmlFor="termins">
              Acepto los <span className="underline hover:cursor-pointer hover:text-blue-700">Terminos de
              servicio</span>
            </label>
          </div>
        </div>
