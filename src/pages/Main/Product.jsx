                ...
                <div className="flex flex-col gap-2 bg-white border rounded-md shadow-xl">
                    <div className="flex flex-col-reverse md:flex-row gap-2 p-2">
                        ...
                        <div className="flex md:flex-col gap-2 md:h-96">
                            {
                                [1, 1, 1, 1, 1].map(n => (
                                    <div key={Math.random()} className="w-12 h-12 bg-white border rounded-md overflow-hidden">
                                        <img src="https://cdn.pixabay.com/photo/2014/09/13/21/48/drill-444510_1280.jpg" alt="product-img" className="w-full h-full object-cover" />
                                    </div>
                                ))
                            }
                        </div>
                ...
                <div className="flex flex-col">
                    <div className="h-min bg-white border rounded-md flex flex-col px-4 py-8">
                        ...
                        <div className="flex items-center gap-2 py-4">
                            ...
                            {productInfo.offPercent > 0 ? <p className="text-xs font-bold text-green-600">{productInfo.offPercent}% off</p> : ""}
                        </div>
                        <div className="flex flex-col md:flex-row items-center gap-2 mt-4">
                            <button className="w-full px-4 py-2 border rounded-full flex justify-center items-center gap-2 text-xs font-bold">
                                <FaShoppingCart size="14px" />
                                Agregar al carrito
                            </button>
                            <button className="w-full px-4 py-2 border rounded-full flex justify-center items-center gap-2 text-xs font-bold bg-blue-700 text-white">
